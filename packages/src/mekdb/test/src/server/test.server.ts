...
// SuphiDataStoreTest.UpdateAsync("MightTea", (oldValue) => {
// 	return {
// 		coins: oldValue.coins + 1,
// 	};
// });
// print("GetAsync: ", SuphiDataStoreTest.GetAsync("MightTea"));
// print("HasAsync: ", SuphiDataStoreTest.HasAsync("MightTea"));
// print("SetAsync: ", SuphiDataStoreTest.SetAsync("MightTea", { coins: 31 }));
